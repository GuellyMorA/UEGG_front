            ...
            <v-card elevation="10" class="withbg">
                <v-card-item>
                    <div class="d-sm-flex align-center justify-space-between pt-sm-2">
                        <v-card-title class="text-h5">Seguimiento al proceso penal 1302 y 1320 </v-card-title>
                    </div>
                    <v-form v-model="valid" class="">
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.etapaPreliminar" label="Etapa preliminar" hide-details required></v-text-field>
                            </v-col>
                            ...
                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.preparatoriaImputacionFormal" label="Preparatoria imputación formal" hide-details required></v-text-field>
                            </v-col>

                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.jucioAcusacionFormal" label="Jucio acusación formal" hide-details required></v-text-field>
                            </v-col>
                            ...
                            <v-col cols="12" md="3" >
                                <v-text-field v-model="form.otraFormaConclusionProceso" label="Otras formas de conclusión del proceso" hide-details required></v-text-field>
                            </v-col>
