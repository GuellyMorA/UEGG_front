                ...
                <v-card-item>
                    ...
                    <v-form v-model="valid" class="">
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="3" >
                                <v-checkbox v-model="form.remisionDnaContrareferencia" label="¿ la DNA remitio contra referencia ?" required></v-checkbox>
                            </v-col>
                            
                            <v-col cols="12" md="3" >
                                <v-checkbox v-model="form.cambioInfraccionDelito" label="¿ Cambio la infracción a delito ?" required></v-checkbox>
                            </v-col>
                            ...
                            <v-col cols="12" md="6" >
                                <v-checkbox v-model="form.presentoDenunciaMinisterioPublica" label="¿ Se presento la denuncia al ministerio público ?" required></v-checkbox>
                            </v-col>
