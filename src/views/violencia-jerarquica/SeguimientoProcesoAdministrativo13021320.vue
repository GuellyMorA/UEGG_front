            ...
            <v-card elevation="10" class="withbg">
                <v-card-item>
                    <div class="d-sm-flex align-center justify-space-between pt-sm-2">
                        <v-card-title class="text-h5">Seguimiento al proceso administrativo 1302 y 1320 </v-card-title>
                    </div>
                    <v-form v-model="valid" class="">
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.autoInicial" label="Auto inicial" hide-details required></v-text-field>
                            </v-col>
                            ...
                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.autoFinal" label="Auto final del proceso" hide-details required></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.recursoRevocatoria" label="Recurso de revocatoria" hide-details required></v-text-field>
                            </v-col>

                            <v-col cols="12" md="4" >
                                <v-text-field v-model="form.recursoJuridico" label="Recurso jurídico" hide-details required></v-text-field>
                            </v-col>
